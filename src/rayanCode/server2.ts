...
app.post("/initializeRoadmap", async (req: Request, res: Response) => {
    try {
        const {
            preId,
            roadmapId,
...
app.get("/redeemReward", async (req: Request, res: Response) => {
    try {
...
app.post("/fundPlastik", async (req: Request, res: Response) => {
    try {
        ...
        const tx = await FundPlastik(
            lucid,
            preId,
            roadmapId,
            BigInt(soldPlasticCredit)
        );
...
app.get("/fundUsdm", (req: Request, res: Response) => {
